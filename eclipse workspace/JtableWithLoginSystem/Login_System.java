		...
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					input = new Scanner(new File("C:\\\\Users\\\\My-PC\\\\eclipse-workspace\\\\LogInSystem\\\\UserInfo.txt"));
					...
					while(input.hasNextLine()) {
						...
						nameL.add(lineSplit[0]);	passL.add(lineSplit[2]);
	...
	//==>	
		...
		btnExit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(JOptionPane.showConfirmDialog(frame,"Are you sure you want to  exit?","CONFIRMATION MESSAGE",
		...
		btnTable.setFont(new Font("Tahoma", Font.BOLD,  13));
		btnTable.setBounds(23, 250, 380, 35);
