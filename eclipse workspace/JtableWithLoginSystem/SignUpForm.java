...
public class SignUpForm {
	 ...
	 */
        public static String uname, upass, cpass, email;
	...
	//==>	
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				uname = us_name.getText();
				upass = s_pass.getText();
				cpass = cnf_pass.getText();
                                email = mail.getText();
				...
				if(!upass.equals(cpass)) {
					...
					try {   
						...
						Files.write(Paths.get("C:\\Users\\My-PC\\eclipse-workspace\\LogInSystem\\UserInfo.txt"), uinfo.getBytes(), StandardOpenOption.APPEND);
